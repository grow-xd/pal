...
<template>
  ...
  <nav
            v-if="isLoggedIn" class="z-20 flex shrink-0 grow-0 justify-around gap-4 border-t border-gray-200 bg-white/50 p-2.5 shadow-lg backdrop-blur-lg dark:border-slate-600/60 dark:bg-slate-800/50 fixed top-2/4 -translate-y-2/4 left-6 min-h-[auto] min-w-[64px] flex-col rounded-lg border">
            ...
            <RouterLink to="friends"
                ...
                <small class="text-center text-xs font-medium"> Friends </small>
            </RouterLink>
            ...
            <RouterLink to="Communities"
                ...
                <small class="text-center text-xs font-medium"> Communities </small>
            </RouterLink>
        ...
        <nav
            v-else class="z-20 flex shrink-0 grow-0 justify-around gap-4 border-t border-gray-200 bg-white/50 p-2.5 shadow-lg backdrop-blur-lg dark:border-slate-600/60 dark:bg-slate-800/50 fixed top-2/4 -translate-y-2/4 left-6 min-h-[auto] min-w-[64px] flex-col rounded-lg border">
            <RouterLink to="login"
                class="flex aspect-square min-h-[32px] w-16 flex-col items-center justify-center gap-1 rounded-md p-1.5 bg-indigo-50 text-indigo-600 dark:bg-sky-900 dark:text-sky-50">
                <!-- HeroIcon - User -->
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            ...
            <a href="/Signup"
                ...
                <small className="text-xs font-medium">Signup</small>
            </a>
        </nav>
