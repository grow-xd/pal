            ...
            <div class="flex flex-col px-6">
                ...
                <div class="my-2 flex flex-row space-x-2">
                    ...
                    <div class="flex flex-row">
                        <svg class="mr-2 h-4 w-4 fill-gray-500/80" xmlns="http://www.w3.org/2000/svg" fill="none"
                    ...
                    <div class="flex flex-row">
                        ...
                        <div class="text-xs text-gray-400/80 hover:text-gray-400">{{ location }}</div>
                    </div>
                ...
                <div class="mt-2 flex flex-row items-center space-x-5">
                    ...
                    <a href="#"
                        ...
                        <div class="flex flex-row items-center justify-center">
                            ...
                            <span class="font-bold text-gray-600"> {{ friends.length }} </span>
                        </div>
...
export default {
    ...
    methods: {
        ...
        getfriends() {
            ...
            fetch(`http://localhost:8000/api/userprofiles/${this.id}/friends/`, requestOptions)
                .then(result => result.json())
                .then(response => {
        ...
        addfriend(e) {
            ...
            fetch(`http://localhost:8000/api/add_friend/${this.frndName}/`, requestOptions)
                .then(result => result.json())
                .then(response => {
