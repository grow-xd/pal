<template>
    <div class="bg-blue-500 rounded-xl m-2 shadow-xl duration-700 p-2">
            ...
            <div class="flex flex-col px-6">
                ...
                <div class="flex h-8 flex-row">
                    ...
                    <a href="" target="_blank">
                        <h2 class="text-lg font-semibold">Rishabh</h2>
                    </a>
                ...
                <div class="my-2 flex flex-row space-x-2">
                    ...
                    <div class="flex flex-row">
                        <svg class="mr-2 h-4 w-4 fill-gray-500/80" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor">
                        ...
                        <div class="text-xs text-gray-400/80 hover:text-gray-400">username</div>
                    </div>
        ...
        <div class="flex flex-row justify-center h-screen items-center">
            ...
            <div
                class="grid bg-blue-300 text-xl h-2/3 w-2/3 text-white text-center m-2 p-2 rounded-xl place-content-center">
                ...
                <div class=" overflow-y grid grid-cols-3 md:grid-cols-5 duration-700">
                    ...
                    <div
                        class="bg-blue-100 shadow-xl rounded-xl text-center p-2 m-1 text-sm md:text-lg text-black hover-trigger duration-700">
                        <div
                    ...
                    <div class="bg-blue-100 shadow-xl rounded-xl text-center p-2 m-1 text-sm md:text-lg text-black">Rishabh
                    </div>
                    <div class="bg-blue-100 shadow-xl rounded-xl text-center p-2 m-1 text-sm md:text-lg text-black">Rishabh
                    </div>
                    <div class="bg-blue-100 shadow-xl rounded-xl text-center p-2 m-1 text-sm md:text-lg text-black">Rishabh
                ...
                <div class=" overflow-y grid grid-cols-3 md:grid-cols-5 duration-700 align-middle">
                    ...
                    <div class="bg-blue-100 shadow-xl rounded-xl text-center p-2 m-1 text-sm md:text-lg text-black">
                        Rcommunity
                    </div>
                    <div class="bg-blue-100 shadow-xl rounded-xl text-center p-2 m-1 text-sm md:text-lg text-black">
                        Rcommunity
            ...
            <div
                class="grid bg-blue-300 text-xl h-2/3 w-2/3 text-white text-center m-2 p-2 rounded-xl duration-700 place-content-center">
                <label class="block mt-3 font-semibold no-underline"> Add a new friend </label>
                ...
                <button type="submit" 
                    class="m-2 bg-purple-500 text-white py-1 px-3 rounded-md hover:bg-purple-600 ">Add Friend</button>

                <hr class="my-12 h-0.5 border-t-0 bg-neutral-100 opacity-100 dark:opacity-50 m-6 mt-20" />
                <div class="flex flex-col md:flex-row justify-between gap-2">
                    <div>
                        <label class="block mt-3 font-semibold no-underline"> Join Community </label>
                        <input type="text" placeholder="Community Unique Code"
                            class="border h-5 text-black px-3 py-5 mt-2 justify-center hover:outline-none focus:outline-none focus:ring-indigo-500 focus:ring-1 rounded-md">
                        <button type="submit"
                            class="m-2 bg-purple-500 text-white py-1 px-3 rounded-md hover:bg-purple-600 ">Join</button>
                    </div>
                    <div>
                        <label class="block mt-3 font-semibold no-underline"> Create Community </label>
                        <input type="text" placeholder="Community Name"
                            class="border h-5 text-black px-3 py-5 mt-2 justify-center hover:outline-none focus:outline-none focus:ring-indigo-500 focus:ring-1 rounded-md">
                        <button type="submit"
                            class="m-2 bg-purple-500 text-white py-1 px-3 rounded-md hover:bg-purple-600 ">Create</button>
                    </div>
                </div>
            </div>
        </div>
