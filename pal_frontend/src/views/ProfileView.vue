<template>
  <div class="bg-[url('../assets/img5.jpg')] rounded-xl m-2 shadow-xl duration-700 p-2">
    <div
      class="flex flex-row rounded-lg border border-gray-200/80 bg-white p-6 m-3"
    >
      <div class="relative">
        <img
    ...
    <div class="flex flex-row justify-center h-screen items-center">
      <div
        class="grid bg-blue-600 text-xl h-2/3 w-2/3 text-white text-center m-2 p-2 rounded-xl place-content-center"
      >
        ...
        <hr
          class="my-12 h-0.5 border-t-0 bg-neutral-100 opacity-100 dark:opacity-50 m-6 mt-20"
        />
        ...
        <div
          class="overflow-y grid grid-cols-3 md:grid-cols-5 duration-700 align-middle"
        >
        ...
        <div class="flex flex-col md:flex-row justify-between gap-2">
          <div>
            ...
            <input
              type="text"
              v-model="joinName"
              placeholder="Community Unique Code"
              class="border h-5 text-black px-3 py-5 mt-2 justify-center hover:outline-none focus:outline-none focus:ring-indigo-500 focus:ring-1 rounded-md"
            />
            <button
              type="submit"
